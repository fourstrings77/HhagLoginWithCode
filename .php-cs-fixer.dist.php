...
return (new Config())
    ...
    ->setRules([
        ...
        'header_comment' => ['header' => '', 'separate' => 'bottom', 'location' => 'after_declare_strict', 'comment_type' => 'comment'],
    ])
    ->setUsingCache(true)
    ->setCacheFile(Path::join($_SERVER['SHOPWARE_TOOL_CACHE_ECS'] ?? __DIR__, 'php-cs-fixer.cache'))
    ->setFinder(
        (new Finder())
